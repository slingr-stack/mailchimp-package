...
```javascript
var response = pkg.mailchimp.patch('/ecommerce/stores/:store_id/orders/:order_id', body)
var response = pkg.mailchimp.patch('/ecommerce/stores/:store_id/orders/:order_id')
var response = pkg.mailchimp.post('/batch-webhooks', body)
var response = pkg.mailchimp.post('/batch-webhooks')
var response = pkg.mailchimp.get('/reports/:campaign_id/unsubscribed/:subscriber_hash')
var response = pkg.mailchimp.delete('/ecommerce/stores/:store_id/orders/:order_id/lines/:line_id')
